    ...
    <section className="mx-5 px-10 text-justify">
      ...
      >
        <div className="mt-12 space-y-6">
          <p className="mb-12">
            I see projects as more than just tasks to complete - they are opportunities to bring ideas to life, solve real problems, and create meaningful impact. For each project, I take a thoughtful, detail-oriented approach that blends innovative thinking with strategic planning. Below are some of the exciting projects I have worked on.
          </p>
