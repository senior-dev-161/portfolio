    ...
    <section className="mx-5 px-10 text-justify">
      ...
      >
        <div className="mt-12 space-y-6">
          <p className="mb-12">
            I believe education plays a key role in both personal and professional growth. Throughout my academic journey, I’ve actively pursued knowledge and taken advantage of learning opportunities that have shaped my skills and broadened my perspective. Below is an overview of my educational background and academic achievements.
          </p>
          {educations ? (
            <TimelineList>
